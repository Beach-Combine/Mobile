...
class DifferentAreaScreen extends StatefulWidget {
  const DifferentAreaScreen({super.key});

  @override
  State<DifferentAreaScreen> createState() => _DifferentAreaScreenState();
}

class _DifferentAreaScreenState extends State<DifferentAreaScreen> {
